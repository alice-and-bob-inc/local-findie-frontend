    ...
    return (
        <div className="min-h-full min-w-full bg-home-page bg-no-repeat bg-contain bg-[center_bottom_10px]">
            ...
            <div className="pt-16">
                ...
                <h3 className="block mx-auto min-w-xl max-w-4xl mx-50 text-xl text-center leading-loose font-semibold text-gray-700 [text-shadow:_0_4px_4px_rgb(255_255_255_/_0.8)]">
